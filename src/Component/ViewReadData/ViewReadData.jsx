...
const ViewReadData = () => {
    ...
    const detailsReadBooks =ReadData .find(item => item.id == idInt) 

    const {author,image,bookName,yearOfPublishing,publisher,category,totalPages,review,tags,rating} = detailsReadBooks;
    return (
        <div>
